...
public class DataBaseHandler extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_MANGA = "CREATE TABLE "+TABLE_MANGA[0]+" ("+TABLE_MANGA[1]+" INTEGER, "+TABLE_MANGA[2]+" TEXT, "+TABLE_MANGA[3]+" TEXT, "+TABLE_MANGA[4]+" TEXT, "+TABLE_MANGA[5]+" TEXT, "+TABLE_MANGA[6]+" TEXT)";

    private static final String TABLE_GENRE[] = new String[]{"genre","id","name"};
    private static final String CREATE_TABLE_GENRE = "CREATE TABLE "+TABLE_GENRE[0]+" ("+TABLE_GENRE[1]+" INTEGER, "+TABLE_GENRE[2]+" TEXT)";

    private static final String TABLE_MANGA_HAS_GENRE[] = new String[]{"manga_has_genre","id","id_manga","id_genre"};
    private static final String CREATE_TABLE_MANGA_HAS_GENRE = "CREATE TABLE "+TABLE_MANGA_HAS_GENRE[0]+" ("+TABLE_MANGA_HAS_GENRE[1]+" INTEGER, "+TABLE_MANGA_HAS_GENRE[2]+" INTEGER, "+TABLE_MANGA_HAS_GENRE[3]+" INTEGER)";

    private static final String TABLE_MANGA_HAS_CHAPTER[] = new String[]{"manga_has_chapter","id","id_manga","title","number","status"};
    private static final String CREATE_TABLE_MANGA_HAS_CHAPTER = "CREATE TABLE "+TABLE_MANGA_HAS_CHAPTER[0]+" ("+TABLE_MANGA_HAS_CHAPTER[1]+" INTEGER, "+TABLE_MANGA_HAS_CHAPTER[2]+" INTEGER, "+TABLE_MANGA_HAS_CHAPTER[3]+" TEXT, "+TABLE_MANGA_HAS_CHAPTER[4]+" INTEGER, "+TABLE_MANGA_HAS_CHAPTER[5]+" INTEGER NULL)";

    private static final String TABLE_CHAPTER_HAS_IMAGES[] = new String[]{"chapter_has_images","id","id_chapter","url"};
    private static final String CREATE_TABLE_CHAPTER_HAS_IMAGES = "CREATE TABLE "+TABLE_CHAPTER_HAS_IMAGES[0]+" ("+TABLE_CHAPTER_HAS_IMAGES[1]+" INTEGER, "+TABLE_CHAPTER_HAS_IMAGES[2]+" INTEGER, "+TABLE_CHAPTER_HAS_IMAGES[3]+" TEXT)";

    private static final String TABLE_USER[] = new String[]{"user","id","username","password","email","img_profile"};
    private static final String CREATE_TABLE_USER = "CREATE TABLE "+TABLE_USER[0]+" ("+TABLE_USER[1]+" INTEGER, "+TABLE_USER[2]+" VARCHAR(15), "+TABLE_USER[3]+" VARCHAR(15), "+TABLE_USER[4]+" TEXT, "+TABLE_USER[5]+" INTEGER)";

    private static final String TABLE_USER_FAVORITES_MANGA[] = new String[]{"user_favorites_manga","id","id_user","id_manga"};
    private static final String CREATE_TABLE_USER_FAVORITES_MANGA = "CREATE TABLE "+TABLE_USER_FAVORITES_MANGA[0]+" ("+TABLE_USER_FAVORITES_MANGA[1]+" INTEGER, "+TABLE_USER_FAVORITES_MANGA[2]+" INTEGER, "+TABLE_USER_FAVORITES_MANGA[3]+" INTEGER)";

    private static final String TABLE_USER_LIKES_MANGA[] = new String[]{"user_likes_manga","id","id_user","id_manga"};
    private static final String CREATE_TABLE_USER_LIKES_MANGA = "CREATE TABLE "+TABLE_USER_LIKES_MANGA[0]+" ("+TABLE_USER_LIKES_MANGA[1]+" INTEGER, "+TABLE_USER_LIKES_MANGA[2]+" INTEGER, "+TABLE_USER_LIKES_MANGA[3]+" INTEGER)";
